...
== Test_FourSwitching Between Modes
...
=== Test_FourNetwork Service Policy Mode
...
=== Test_FourAutomated Promotion of Group Modes
...
==== Test_FourConflict Resolution Between Services In Different Modes
