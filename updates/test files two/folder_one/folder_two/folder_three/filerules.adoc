...
=== Test_FourZero-drift File Protection
...
=== Test_FourBasic File Protections
...
=== Test_FourBehavioral-learning based Allowed Applications in Discover Mode
...
=== Test_FourCreating Custom File/Directory Monitoring Rules
...
=== Test_FourFile access rule order precedence
...
== Test_FourSplit Mode File Protections
