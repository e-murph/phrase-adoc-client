...
== Test_FourEgress Control: Allowing Connections to Trusted Internal Services on Other Networks
...
=== Test_FourIngress IP Policy Based on X-FORWARDED-FOR
...
=== Test_FourSpecial Enforcement for Istio ServiceEntry Destinations
...
=== Test_FourVirtual Host Based Network Policy
...
== Test_FourSplit Mode Network Protections
...
== Test_FourBuilt-In Network Threat Detection
