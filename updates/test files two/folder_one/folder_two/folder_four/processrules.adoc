...
=== Test_FourZero-drift Process Protection
...
=== Test_FourBasic Mode Process Protection
...
=== Test_FourBehavioral Learning Based Process Protection
...
=== Test_FourProcess Rules for Nodes
...
=== Test_FourProcess Rules for Custom Groups
...
=== Test_FourProcess Rules Precedence
...
=== Test_FourMonitor/Protect mode (new container started in monitor or protect mode)
...
=== Test_FourCreating process profile rules
...
=== Test_FourBuilt-in Suspicious Process Detection
...
== Test_FourSplit Mode Process/File Protections
