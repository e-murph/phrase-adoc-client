...
* Klicken Sie mit der rechten Maustaste auf AD FS in der AD FS-Verwaltungskonsole und wählen Sie "`Edit Federation Service Properties...`"; verwenden Sie "`Federation Service identifier`".
