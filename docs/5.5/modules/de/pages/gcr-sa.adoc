...
:page-opendocs-slug:  /scanning/registrierung/gcr-sa
...
Oder Sie können die GCP-Benutzeroberfläche verwenden. Gehen Sie zu "`API Library`" und suchen Sie nach "`Artifact Registry API`" und stellen Sie sicher, dass es für Ihr Projekt aktiviert ist. Siehe Abbildung 7.
