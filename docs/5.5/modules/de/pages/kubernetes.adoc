...
Siehe den unteren Abschnitt zur Angabe von dedizierten Manager- oder Controller-Knoten mit Hilfe von Knotenbeschriftungen. 
...
== Kubernetes Deployment YAML für v5.4.2 und höher
