...
Um alle Bilder zu erhalten, werden wir das Diagramm selbst verwenden. Mit https://helm.sh/[Helm] fügen wir das Repo hinzu und laden das Diagramm herunter. Wir werden auch https://github.com/containers/skopeo[skopeo] für das Herunterladen und Hochladen verwenden.
...
Jetzt müssen wir nur noch mit einem ähnlichen Befehl dekomprimieren. Folgendes wird im Verzeichnis `neuvector` ausgegeben.
