...
Alle {product-name} Container werden nun live aktualisiert. Alle Richtlinien, Protokolle und Konfigurationen sind davon nicht betroffen. Die Live-Grafik wird automatisch neu generiert, sobald neuer Live-Verkehr zwischen Containern fließt.
