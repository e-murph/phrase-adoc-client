...
En plus de la stratégie fédérée, la gestion multi-clusters prend en charge la surveillance de chaque cluster distant dans une page récapitulative, comme indiqué ci-dessous.
