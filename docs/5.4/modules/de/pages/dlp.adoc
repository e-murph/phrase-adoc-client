...
* Kontext. Wo wird nach der Musterübereinstimmung gesucht. Wählen Sie "Paket" für eine umfassende Prüfung der gesamten Netzwerkverbindung oder beschränken Sie die Prüfung auf die URL, den Header oder den Body.
