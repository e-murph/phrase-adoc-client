...
_In den Kriterien können_ Platzhalter_'' verwendet werden, z. B. 'address=_.google.com'. Für einen flexibleren Abgleich verwenden Sie die Tilde '~', um anzugeben, dass eine Regex-Übereinstimmung gewünscht ist. Zum Beispiel, um Etiketten 'policy~public.*-ext1' für die Label-Richtlinie zu finden.
