...
Im Monitor-Modus überwacht {product-name} Unterhaltungen und erkennt Verstöße gegen Ihre Sicherheitsrichtlinien zur Laufzeit. In diesem Modus werden keine neuen Regeln von {product-name} erstellt, aber Regeln können jederzeit manuell hinzugefügt werden.
...
[NOTE]
====
Die obigen Angaben gelten nur für Netzwerkregeln
====
