...
Ein einfacher Ping-Befehl mit hoher Nutzlast zeigt zum Beispiel den Ping.Death-Angriff in der Konsole an. Um dies auszuprobieren, geben Sie die IP-Adresse eines der Container ein (interne IP des Containers).
