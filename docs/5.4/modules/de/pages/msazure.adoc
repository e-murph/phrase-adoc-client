...
. Kehren Sie zur Azure-Verwaltungskonsole zurück, um die "Grundlegende SAML-Konfiguration" einzurichten. Kopieren Sie die Umleitungs-URL der Konsole {product-name} in die beiden Felder "Bezeichner" und "Antwort-URL".
+
