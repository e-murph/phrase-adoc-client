...
----
+
Une fois les fichiers de certificats mis à jour, redémarrez les déploiements afin d'utiliser le certificat mis à jour : 
+
[source,bash]
----
