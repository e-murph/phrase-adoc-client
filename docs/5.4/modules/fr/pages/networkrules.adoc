...
Pour permettre aux conteneurs de se connecter à des services sur d'autres réseaux internes, il faut d'abord créer un groupe, puis une règle pour ce groupe.
