...
*Nœud maître Taches et tolérances*
...
Pour empêcher l'enforcer d'être déployé sur un nœud contrôleur, s'il s'agit d'un nœud de gestion dédié (sans conteneurs d'applications à surveiller), ajoutez une nodeAffinity à la section yaml de l'enforcer. Par exemple :
