...
+
____
Définissez la variable à l'adresse IP de l'hôte pour le premier contrôleur et définissez-la à l'adresse IP de l'hôte du contrôleur principal pour les autres contrôleurs et agents d'exécution. Il n'est pas nécessaire de définir cette IP pour les déploiements basés sur Kubernetes, il suffit d'utiliser le fichier d'exemple.
____
