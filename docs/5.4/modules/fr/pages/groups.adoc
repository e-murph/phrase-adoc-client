...
Les nœuds peuvent ensuite être mis en mode "Monitor" ou "Protect", où {product-name} alertera si un processus démarre en mode "Monitor", et bloquera ce processus en mode "Protect".
...
+
____
Sélectionnez les conteneurs en fonction de leur nom d'instance. Exemples : container=nodejs_1, container@nodejs
____
