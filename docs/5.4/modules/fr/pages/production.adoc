...
Prenez des précautions particulières pour vous assurer qu'il y a toujours un contrôleur en marche et prêt, en particulier lors des mises à jour et des redémarrages du système d'exploitation hôte ou de la plateforme d'orchestration.
...
Les ConfigMaps et la sauvegarde du stockage permanent ne sont lus que lorsqu'un nouveau cluster {product-name} est déployé, ou lorsque le cluster tombe en panne et est redémarré. Ils ne sont pas utilisés lors des mises à niveau en continu.
...
Veuillez consulter chaque section d'exemple pour obtenir des instructions sur la manière de maintenir la base de données CVE à jour.
