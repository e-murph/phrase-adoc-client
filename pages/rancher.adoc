= Test Rancher Deployment
:revdate: 2024-12-03
:page-revdate: {revdate}
:page-opendocs-origin: /02.deploying/03.rancher/03.rancher.md
:page-opendocs-slug: /deploying/rancher

== Test Deploy and Manage {product-name} through Rancher Extensions or Apps & Marketplace
...
=== Test {product-name} UI Extension for Rancher
...
=== Test NeuVector/Rancher SSO Permission Resources
...
==== Test Mapped Permission Resources for `Global/Cluster` Role
...
==== Test Mapped Permission Resources for `Project/Namespace` Role
...
=== Test Disabling {product-name}/Rancher SSO
...
=== Test Rancher Legacy Deployments
...
== Test Deploy Without Privileged Mode
...
== Test Using Node Labels for Manager and Controller Nodes
