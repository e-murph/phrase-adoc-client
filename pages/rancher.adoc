= Test_TwoRancher Deployment
:revdate: 2024-12-03
:page-revdate: {revdate}
:page-opendocs-origin: /02.deploying/03.rancher/03.rancher.md
:page-opendocs-slug: /deploying/rancher

== Test_TwoDeploy and Manage {product-name} through Rancher Extensions or Apps & Marketplace
...
=== Test_Two{product-name} UI Extension for Rancher
...
=== Test_TwoNeuVector/Rancher SSO Permission Resources
...
==== Test_TwoMapped Permission Resources for `Global/Cluster` Role
...
==== Test_TwoMapped Permission Resources for `Project/Namespace` Role
...
=== Test_TwoDisabling {product-name}/Rancher SSO
...
=== Test_TwoRancher Legacy Deployments
...
== Test_TwoDeploy Without Privileged Mode
...
== Test_TwoUsing Node Labels for Manager and Controller Nodes
