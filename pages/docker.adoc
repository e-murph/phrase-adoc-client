...
== Test Deploy {product-name} Containers Using Docker Native or UCP/Swarm
...
=== Test Deploy Allinone for High Availability
...
=== Test Deploy Allinone using docker-compose (privileged mode)
...
=== Test Add an enforcer container using docker-compose (privileged mode)
...
=== Test Deploy the {product-name} Scanner Container
...
=== Test Deployment Without Using Privileged Mode
...
=== Test Deploy allinone (NO privileged mode) with docker-compose
...
=== Test Deploy enforcer (NO privileged mode) with docker-compose
...
=== Test Deploy allinone (privileged mode) with docker run
...
=== Test Deploy enforcer (privileged mode) with docker run
...
=== Test Deploy allinone (NO privileged mode) with docker run
...
=== Test Deploy enforcer (NO privileged mode) with docker run
...
== Test Deploy Separate {product-name} Components on Different Hosts
...
== Test Monitoring and Restarting {product-name}
...
== Test Deploying Without Privileged Mode
