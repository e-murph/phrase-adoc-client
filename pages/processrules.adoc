...
=== Test Zero-drift Process Protection
...
=== Test Basic Mode Process Protection
...
=== Test Behavioral Learning Based Process Protection
...
=== Test Process Rules for Custom Groups
...
=== Test Monitor/Protect mode (new container started in monitor or protect mode)
...
=== Test Creating process profile rules
...
=== Test Built-in Suspicious Process Detection
...
== Test Split Mode Process/File Protections
