...
=== Test_TwoCommunity Operator v1.2.7 for Helm Chart 1.8.2
...
=== Test_TwoHelm Chart 1.8.2

* Add controller ingress and route host options.

=== Test_TwoCertified Operator v1.2.8 for {product-name} v4.3.1
...
=== Test_TwoHelm Chart update 1.8.0 July 2021
...
=== Test_TwoOther Integrations July 2021
...
=== Test_TwoHelm Chart update 1.7.5 May 2021
...
=== Test_TwoOperator Updates April 2021
...
=== Test_TwoJenkins Plug-In v1.12 March 2021
...
=== Test_TwoUpdate Helm Chart to 1.7.1 March 2021
...
=== Test_TwoJenkins Plug-In v1.11 February 2021
...
=== Test_TwoImportant Helm Chart Update November 2020
