...
== Test_TwoOverview of {product-name} Scanning
...
=== Test_TwoKubernetes Resource Deployment File Scanning
...
== Test_TwoManaging Vulnerabilities and Compliance
...
=== Test_TwoAutomated Run-Time Scanning
...
== Test_TwoAutomated Actions, Mitigations, and Responses Based on Vulnerabilities
...
=== Test_TwoFederated Registries for Distributed Image Scanning Results
...
=== Test_TwoAuto-scaling of Scanner Pods
