...
=== Test 4.4.4-s1 Security Patch February 2022
...
=== Test Other Updates February 2022
...
* Add preconfigured PSP Best Practice rule to Admission Control rules. For example the following preset criteria can alert/block a deployment: Run as Privileged, Run as Root, Share host's IPC Namespaces = Test true, Share host's Network = Test true, Share host's PIC Namespaces = Test true.
...
==== Test XFF-FORWARDED-FOR Behavior Details
...
==== Test Kubernetes 1.19+ and CRD Exports
...
==== Test Admission Control for Pod Sharing
...
=== Test 4.0.0.s1 October 2020

==== Test Security Patch for {product-name} Containers
...
==== Test Summary of Major Operational Changes
...
==== Test Upgrading from 3.x to 4.0
