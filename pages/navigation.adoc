...
===== Test X-FORWARDED-FOR Behavior Details
...
==== Test Settings -> LDAP/AD, SAML, and OpenID Connect
...
==== Test Multiple Cluster Management
...
=== Test Icon Descriptions in Legend > Network Activity
...
==== Test Group/Container/Service Mesh in discovery
...
==== Test Group/Container/Service Mesh being monitored

This container is in Monitor mode, where violations will be logged but not blocked.

==== Test Group/Container/Service Mesh being protected
