...
=== Test Complete Sample {product-name} ConfigMap (initcfg.yaml)
...
data:
  fedinitcfg.yaml: |
    # ============ Test this section is used for primary cluster ============ Test >>>
    ...
    # <<< ============ Test this section is used for primary cluster ============
    # ============ Test this section is used for remote cluster ============ Test >>>
    # Optional. If specified, it overwrites the cluster name specified in the system configuration in the sysinitcfg.yaml file
    ...
    # Optional. Supported value: https
    Use_Proxy: ""
    # <<< ============ Test this section is used for remote cluster ============
...
=== Test Federated ConfigMap Examples (fedinitcfg.yaml)
...
== Test Protect Sensitive Data Using a Secret
...
== Test ConfigMaps and Persistent Storage
