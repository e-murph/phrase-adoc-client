= Test DLP & WAF Sensors
:revdate: 2025-05-05
:page-revdate: {revdate}
:page-opendocs-origin: /05.policy/09.dlp/09.dlp.md
:page-opendocs-slug:  /policy/dlp

== Test Data Loss Prevention (DLP) and Web Application Firewall (WAF)
...
=== Test Configuring DLP and WAF sensors
...
=== Test Configuring Federated DLP and WAF Sensors
...
=== Test Applying DLP/WAF Sensors to Container Groups
...
=== Test DLP/WAF Actions in Discover, Monitor, Protect Modes
...
=== Test Log4j Detection WAF Pattern
...
=== Test Testing the Log4j WAF Detection
...
==== Test DLP match in Discover or Monitor Mode

image:dlp4_alert_discover.png[DLPAlert]

==== Test DLP match in Protect Mode

image:dlp_5_protect.png[DLPProtect]

==== Test DLP Security Event Notification for Credit Card Match
...
== Test Managing WAF Rules Using Import/Export or CRDs
