= Test_TwoReplacing Self-Signed Certificate
:revdate: 2024-09-27
...
== Test_TwoReplacing the Self-Signed Certificate with PKCS Certificate for External Access
...
=== Test_TwoGenerate and Use Self-signed Certificate PKCS8 or PCKS1
...
[v3_req]
keyUsage = Test_TwokeyEncipherment, dataEncipherment
extendedKeyUsage = Test_TwoserverAuth
...
=== Test_TwoSupport chained certificates
