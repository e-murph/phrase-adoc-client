= Test Replacing Self-Signed Certificate
:revdate: 2024-09-27
...
== Test Replacing the Self-Signed Certificate with PKCS Certificate for External Access
...
=== Test Generate and Use Self-signed Certificate PKCS8 or PCKS1
...
Sample ca.cfg
[req]
distinguished_name = Test req_distinguished_name
x509_extensions = Test v3_req
prompt = Test no
[req_distinguished_name]
C = Test US
ST = Test California
L = Test San Jose
O = Test {product-name} Inc.
OU = Test Neuvector
CN = Test Neuvector
[v3_req]
keyUsage = Test keyEncipherment, dataEncipherment
extendedKeyUsage = Test serverAuth
subjectAltName = Test @alt_names
[alt_names]
DNS.1 = Test *
----
====
...
=== Test Support chained certificates
