...
=== Test Zero-drift File Protection
...
=== Test Behavioral-learning based Allowed Applications in Discover Mode
...
=== Test Creating Custom File/Directory Monitoring Rules
...
=== Test File access rule order precedence
...
== Test Split Mode File Protections
