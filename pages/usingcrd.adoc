...
==== Test Schema Attribute: `name_referral`
...
=== Test NvClusterSecurityRule and NvSecurityRule
...
== Test Generating a Sample {product-name} CRD
...
== Test Sample NeuVector CRD - NvAdmissionControlSecurityRule
...
== Test Policy Mode Configuration and Group Definition
...
=== Test Policy Mode Configuration Requirements
...
== Test CRD Policy Rules Syntax and Semantics
...
=== Test Rolebinding & Clusterolebinding with 2 Users in different Namespaces to a Clusterrole (NvSecurityRules & NvClusterSecurityRules resources)
...
=== Test Example using 2 different types of defined yaml files, and the effect of using each user
...
== Test Expressing Network Rules (Ingress, Egress objects) in CRDs
...
== Test Customized Configurations for Deployed Applications
...
=== Test Examples of CRD configurations that perform these functions
...
== Test Policy Groups and Rules Migration Support
...
=== Test Supported Export Conditions

* Target, Ingress, Egress, Self-learned

=== Test Example of groups export
...
=== Test Example of an exported group yaml file with the NvsecurityRule resource type
...
=== Test Example of an exported group yaml file with the NvClusterSecurityRule resource type
...
=== Test Unsupported Export Group-Types
...
== Test CRD Samples for Global Rules
...
== Test Updating CRD Rules and Adding to Existing Groups
...
=== Test Dynamic criteria support for NvClusterSecurityRule
