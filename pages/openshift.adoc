...
=== Test_Two{product-name} Images on Docker Hub
...
== Test_TwoUpdating the CVE Database on OpenShift Deployments
...
== Test_TwoEnable/Disable Scheduling on the Master Node
...
== Test_TwoOpenShift Deployment in Non-Privileged Mode
