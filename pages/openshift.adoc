...
=== Test {product-name} Images on Docker Hub
...
== Test Updating the CVE Database on OpenShift Deployments
...
== Test Enable/Disable Scheduling on the Master Node
...
== Test OpenShift Deployment in Non-Privileged Mode
