...
== Test Integrating with IBM Qradar
...
=== Test IBM QRadar and {product-name} DSM
...
=== Test How to Integrate {product-name} with QRadar
...
=== Test Configure {product-name} to Send Syslog to QRadar
...
=== Test Configure QRadar to Analyze {product-name} Logs
...
=== Test Verify the Log Activities
