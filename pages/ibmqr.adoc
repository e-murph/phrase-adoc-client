...
== Test_TwoIntegrating with IBM Qradar
...
=== Test_TwoIBM QRadar and {product-name} DSM
...
=== Test_TwoHow to Integrate {product-name} with QRadar
...
=== Test_TwoConfigure {product-name} to Send Syslog to QRadar
...
=== Test_TwoConfigure QRadar to Analyze {product-name} Logs
...
=== Test_TwoVerify the Log Activities
