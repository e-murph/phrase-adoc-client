...
=== Test How to Improve the Score

==== Test {product-name} Protection Mode
...
==== Test Privileged and/or Root Containers
...
=== Test How to Customize Which Container Groups Are Included in the Score
