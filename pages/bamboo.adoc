...
== Test_TwoScan for Vulnerabilities during Bamboo Build Pipeline
...
=== Test_TwoConfigure Global Settings
...
=== Test_TwoConfigure the Repository and Build Policy
