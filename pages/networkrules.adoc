...
== Test Egress Control: Allowing Connections to Trusted Internal Services on Other Networks
...
=== Test Ingress IP Policy Based on X-FORWARDED-FOR
...
=== Test Special Enforcement for Istio ServiceEntry Destinations
...
=== Test Virtual Host Based Network Policy
...
== Test Split Mode Network Protections
...
== Test Built-In Network Threat Detection
