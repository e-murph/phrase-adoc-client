= Test Replacing Internal Certificates
:revdate: 2025-01-27
...
== Test Internal Communication and Certificates
...
=== Test Replacing Certificates Used in Internal Communications of {product-name}
...
CN = Test Neuvector
[v3_req]
keyUsage = Test digitalSignature, keyEncipherment, dataEncipherment
extendedKeyUsage = Test serverAuth, clientAuth
subjectAltName = Test @alt_names
[alt_names]
DNS.1 = Test Neuvector
----
...
=== Test Updating/Deploying with Helm
